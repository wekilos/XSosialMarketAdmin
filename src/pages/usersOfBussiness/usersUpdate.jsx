...
const UserUpdate = () => {
  ...
  const updateUser = () => {
    ...
    formData.append("profile[verified]", user?.profile?.verified ? 1 : 0);
    ...
    user?.profile?.category?.id &&
      formData.append("profile[category_id]", user?.profile?.category?.id);
  ...
  return loading ? (
    ...
    <div className="w-full">
      ...
      <div className="w-full pb-[30px] flex justify-between items-center">
        <h1 className="text-[30px] font-[700]">Biznes hasaplar</h1>
      </div>

      <div className="w-full min-h-[60vh] p-5 bg-white rounded-[8px]">
        <div className=" flex items-center gap-4 pb-5 border-b-[1px] border-b-[#E9EBF0]">
          <div className="border-l-[3px] border-blue h-[20px]"></div>
          <h1 className="text-[20px] font-[500]">Biznes hasap maglumaty</h1>
        </div>
        ...
        <div className="flex items-center   justify-between py-[15px]">
          ...
          <div className="w-[49%]">
            ...
            <Select
              value={user?.profile?.category?.id}
              onChange={(e, newValue) => {
                console.log(e?.target?.value, newValue);
                setUser({
                  ...user,
                  profile: {
                    ...user?.profile,
                    category: { ...user?.profile?.category, id: newValue },
                  },
                });
              }}
              placeholder="Hemmesini görkez"
        ...
        <div className="flex items-center   justify-between py-[15px]">
          <div className="w-[49%]">
            ...
            <textarea
              ...
              className="text-[14px] min-h-[100px] max-h-[200px] w-full mt-1 text-[#98A2B2] font-[400]  border-[1px] border-[#98A2B2] rounded-[6px] px-5 py-3 outline-none "
              placeholder="Girizilmedik"
              type="text"
            />
          </div>
        ...
        <div className="flex mt-5 items-center border-t-[1px] justify-between py-[30px]">
          <div className="w-[380px]">
            <h1 className="text-[18px] font-[500]">Tassyklanan hasap</h1>
            <p className="text-[14px] mt-2 font-[500] text-[#98A2B2]">
              Hasap tassyklanan ýa-da tassyklanmadygyny görkezmek üçin
            </p>
          </div>
          <div className="flex justify-start w-[49%]">
            <Switch
              checked={user?.profile?.verified == 1 ? true : false}
              onChange={(event) =>
                setUser({
                  ...user,
                  profile: {
                    ...user?.profile,
                    verified: event.target.checked ? 1 : 0,
                  },
                })
              }
            />
