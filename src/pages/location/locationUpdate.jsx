...
const LocationUpdate = () => {
  ...
  const updateLocation = () => {
    ...
    location.title?.length > 0
      ? axiosInstance
          .post("/locations/update/" + id, formData)
          .then((data) => {
            setLoading(true);
    ...
    <div className="w-full">
      ...
      <div className="w-full min-h-[60vh] p-5 bg-white rounded-[8px]">
        <div className=" flex items-center gap-4 pb-5 border-b-[1px] border-b-[#E9EBF0]">
          ...
          <h1 className="text-[20px] font-[500]">Ýerleşýän ýer maglumaty</h1>
        </div>
      ...
      <div className="w-full mt-5 flex justify-between items-center bg-white py-4 px-5 border-[1px] border-[#E9EBF0] rounded-[8px]">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-[14px] font-[400]">
            {location?.updated_at?.slice(0, 10) +
              " / " +
              location?.updated_at?.slice(11, 16)}
          </h1>
        </div>
