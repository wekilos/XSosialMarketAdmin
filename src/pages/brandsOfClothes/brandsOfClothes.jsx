  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full pb-[30px] flex justify-between items-center">
        <h1 className="text-[30px] font-[700]">Geýim markalar</h1>
        <div className="w-fit flex gap-5">
          ...
          <Button
            onClick={() => history.push({ pathname: "/clothebrands/create" })}
          ...
          return loading ? (
            ...
            >
              ...
              <h1 className="text-[14px] flex items-center justify-between gap-4 font-[500] text-[#98A2B2] w-[15%] uppercase">
                ...
                <div
                  onClick={() =>
                    history.push({ pathname: "/clothebrands/" + item?.id })
                  }
        ...
        >
          ...
          >
            <div className="flex w-[350px] border-b-[1px] border-[#E9EBF0] pb-5 justify-between items-center">
              <h1 className="text-[20px] font-[500]">Geýim marka aýyrmak</h1>
            ...
            <div>
              <h1 className="text-[16px] text-center my-10 font-[400]">
                Geýim markany aýyrmak isleýärsiňizmi?
              </h1>
...
export default React.memo(BrandsOfClothes);
