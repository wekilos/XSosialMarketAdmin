    ...
    brand.title?.length > 0
      ? axiosInstance
          ...
          .then((data) => {
            ...
            history.push({ pathname: "/clothebrands" });
          })
          .catch((err) => {
            setLoading(true);
            console.log(err);
    ...
    <div className="w-full">
      ...
      <div className="w-full min-h-[60vh] p-5 bg-white rounded-[8px]">
        <div className=" flex items-center gap-4 pb-5 border-b-[1px] border-b-[#E9EBF0]">
          ...
          <h1 className="text-[20px] font-[500]">Geýim marka maglumaty</h1>
        </div>
...
export default React.memo(BrandOfClothesUpdate);
